...
namespace Ticket
{
    ...
    {
        public static string TicketPrice(dynamic age)
        {
            if (age <= 0)
            {
        ...
        public static string HatGift(string gender)
        {
        ...
        public static string TicketAndGiftResult(dynamic age, string gender)
        {
